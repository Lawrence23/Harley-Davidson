function openPopup(obj,index) {
  ...
  document.getElementById('fade').onclick = function () { closePopup(obj,index); }
...
$(document).ready(function() {
  ...
  $.getJSON('assets/json/bikes.JSON', function(data) {
    ...
    $.each(data.bikes,function(key,value) {
      $container.append('<div class="gallery"><a  href = "javascript:void(0)"><img id="'+value.id+'" src="'+ value.value +'"><span class="caption">'+value.label+'</span></a></div>');
